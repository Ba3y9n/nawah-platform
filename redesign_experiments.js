const fs = require('fs');
let code = fs.readFileSync('src/app/pit-management/experiments/page.tsx', 'utf-8');
...
code = code.replace(/bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-400 hover:to-emerald-500 text-slate-950 font-bold px-6 py-2.5 rounded-xl text-sm transition-all shadow-md shadow-emerald-500\/20/g, 'bg-slate-900 hover:bg-slate-800 text-white font-bold px-6 py-3 rounded-xl text-sm transition-all shadow-md');
code = code.replace(/border-emerald-200\/60/g, 'border-slate-200');
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400 mt-1">
                سجل التجارب مخصص لعرض تجاربك الخاصة. قم بتسجيل الدخول للبدء.
              </p>
            </div>
          </div>
...
fs.writeFileSync('src/app/pit-management/experiments/page.tsx', code, 'utf-8');
console.log("Experiments redesigned");
