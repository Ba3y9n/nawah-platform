...
import { 
  ...
  MapPin, ShieldCheck, ArrowLeft, TrendingUp, PlusCircle, Building2
} from "lucide-react";
...
export default function HomePage() {
  ...
  return (
    <div className="space-y-16 pb-16 bg-white text-slate-100">
      
      {/* HERO SECTION */}
      <section className="relative overflow-hidden pt-12 pb-20 bg-gradient-to-b from-emerald-950 via-slate-950 to-slate-950 border-b border-emerald-900/40">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-6 max-w-4xl">
          
          <div className="inline-flex items-center gap-2 bg-emerald-100/80 border border-emerald-300/60 px-4 py-1.5 rounded-full text-xs font-bold text-amber-300 shadow-lg shadow-emerald-950/50">
          ...
          <p className="text-sm sm:text-base text-emerald-800/90 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 pt-4">
            ...
            <Link
              ...
              className="flex items-center gap-2 bg-emerald-100/80 border border-emerald-300/80 text-emerald-950 font-bold px-6 py-3.5 rounded-2xl text-xs sm:text-sm hover:bg-emerald-200 transition-all shadow-lg"
            >
      ...
      {/* LIVE PLATFORM METRICS FROM DATABASE */}
      <section className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-slate-50/90 border border-emerald-200/80 rounded-3xl p-8 shadow-2xl space-y-6">
          <div className="text-center space-y-1">
            <span className="text-xs font-bold text-amber-400 uppercase tracking-wider block">
              مؤشرات المنصة الفلية المحسوبة مباشرة من DB
            </span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-white p-5 rounded-2xl border border-emerald-900 space-y-2 text-center">
              <span className="text-xs font-bold text-emerald-600 block">إجمالي الكميات المسجلة</span>
              ...
              <span className="text-[10px] text-emerald-600/70 block">مجموع الدفعات بـ DB</span>
            </div>

            <div className="bg-white p-5 rounded-2xl border border-emerald-900 space-y-2 text-center">
              <span className="text-xs font-bold text-amber-400 block">دفعات النوى المسجلة</span>
              <span className="text-2xl sm:text-3xl font-black text-amber-300 block">
                {summary.total_batches_count}
              </span>
              <span className="text-[10px] text-emerald-600/70 block">دفعة ذات كود فريد</span>
            </div>
            ...
            <div className="bg-white p-5 rounded-2xl border border-emerald-900 space-y-2 text-center">
              ...
              <span className="text-[10px] text-emerald-600/70 block">تجربة مرتبطة بالدفعات</span>
            </div>

            <div className="bg-white p-5 rounded-2xl border border-emerald-900 space-y-2 text-center">
              <span className="text-xs font-bold text-emerald-600 block">المصادر الوطنية الموثقة</span>
              <span className="text-2xl sm:text-3xl font-black text-emerald-950 block">
                {summary.total_sources_count}
              </span>
              <span className="text-[10px] text-emerald-600/70 block">مصانع ومراكز تجميع</span>
            </div>
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Link
            href="/pit-management/dashboard"
            className="bg-slate-50/90 border border-emerald-200/70 hover:border-amber-400/80 p-6 rounded-3xl shadow-xl space-y-3 transition-all group block"
          >
            <div className="w-10 h-10 rounded-2xl bg-amber-400 text-emerald-950 flex items-center justify-center font-bold">
              <Layers className="w-5 h-5" />
            </div>
            <h3 className="text-base font-bold text-emerald-950 group-hover:text-amber-300 transition-colors">
          ...
          <Link
            ...
            className="bg-slate-50/90 border border-emerald-200/70 hover:border-amber-400/80 p-6 rounded-3xl shadow-xl space-y-3 transition-all group block"
          >
            <div className="w-10 h-10 rounded-2xl bg-emerald-100 text-amber-300 border border-emerald-300 flex items-center justify-center font-bold">
          ...
          <Link
            ...
            className="bg-slate-50/90 border border-emerald-200/70 hover:border-amber-400/80 p-6 rounded-3xl shadow-xl space-y-3 transition-all group block"
          >
            <div className="w-10 h-10 rounded-2xl bg-emerald-100 text-emerald-700 border border-emerald-300 flex items-center justify-center font-bold">
          ...
          <Link
            ...
            className="bg-slate-50/90 border border-emerald-200/70 hover:border-amber-400/80 p-6 rounded-3xl shadow-xl space-y-3 transition-all group block"
          >
            <div className="w-10 h-10 rounded-2xl bg-amber-950/60 text-amber-400 border border-amber-800/50 flex items-center justify-center font-bold">
          ...
          <Link
            ...
            className="bg-slate-50/90 border border-emerald-200/70 hover:border-amber-400/80 p-6 rounded-3xl shadow-xl space-y-3 transition-all group block"
          >
            <div className="w-10 h-10 rounded-2xl bg-emerald-100 text-emerald-600 border border-emerald-300 flex items-center justify-center font-bold">
