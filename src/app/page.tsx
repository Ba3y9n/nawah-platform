  ...
  const stages = [
    {
      id: 0,
      title: "المصدر",
      desc: "توثيق مصدر النوى، مثل مصانع التمور ومراكز التجميع والمصادر المسجلة.",
      icon: Map,
    },
    {
      id: 1,
    ...
    },
    {
      id: 2,
      title: "التحليل",
      desc: "تحليل بصري تقديري لصور النوى باستخدام الذكاء الاصطناعي، دون اعتباره بديلًا عن الفحوصات المخبرية.",
      icon: BrainCircuit,
    },
    {
      id: 3,
    ...
    },
    {
      id: 5,
      title: "النتائج",
      desc: "تمييز النتائج المتحقق منها بالتجارب عن الاستخدامات التي ما تزال محتملة.",
      icon: BookOpen,
    },
    {
      id: 6,
      title: "الأثر",
      desc: "تتبع المؤشرات والأثر المرتبط بالدفعات، مع التمييز بين البيانات الفعلية والتقديرات الحسابية.",
      icon: Globe,
    },
  ];
...
function InteractiveFeatures() {
  ...
  const features = [
    {
      num: "01",
      title: "مصانع ومراكز تجميع التمور",
      icon: Database,
      ...
      visual: (
        <div className="flex flex-col gap-3 w-full max-w-[220px]">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className={`h-14 rounded-xl border flex items-center px-4 gap-4 transition-all duration-500 ${i === 1 ? "bg-emerald-500 border-emerald-400 shadow-[0_10px_30px_rgba(16,185,129,0.3)] scale-110" : "bg-white border-slate-100 opacity-60"}`}
            >
              <div
                className={`w-2.5 h-2.5 rounded-full shrink-0 ${i === 1 ? "bg-amber-300" : "bg-slate-200"}`}
              />
              <div className="flex-1 space-y-2">
                <div
                  className={`h-1.5 rounded-full w-full ${i === 1 ? "bg-white/40" : "bg-slate-100"}`}
                />
                <div
                  className={`h-1.5 rounded-full w-2/3 ${i === 1 ? "bg-white/20" : "bg-slate-50"}`}
                />
              </div>
            </div>
          ))}
    ...
    {
      num: "03",
      title: "المختبرات والجهات المختصة",
      icon: TestTube2,
    ...
    {
      num: "04",
      title: "الشركات والجهات الصناعية",
        ...
        <div className="flex items-end justify-center gap-4 h-40">
          <div className="w-12 h-full bg-white border border-slate-100 rounded-full p-2 flex flex-col justify-end relative overflow-hidden shadow-sm">
            <motion.div
              ...
              className="w-full bg-slate-100 rounded-full"
            />
          </div>
          <div className="w-14 h-full bg-emerald-500 rounded-full p-2 flex flex-col justify-end shadow-[0_0_30px_rgba(16,185,129,0.3)] relative overflow-hidden">
            <motion.div
              ...
              className="w-full bg-white/95 rounded-full shadow-inner relative"
            >
    ...
    {
      num: "05",
      title: "الجهات المعنية بالاستدامة",
      icon: Globe,
      ...
      visual: (
        <div className="relative w-36 h-36 sm:w-48 sm:h-48 bg-white border border-slate-100 rounded-xl sm:rounded-[2rem] flex items-center justify-center shadow-lg">
          ...
          <motion.div
            ...
            className="absolute left-4 right-4 h-1 bg-emerald-500 shadow-[0_0_20px_#10b981] z-20 rounded-full"
          />
          ...
          >
            ...
            <div className="w-full lg:w-1/2 space-y-6">
              <div className="flex items-center gap-5 mb-8">
                ...
                <div>
                  <div className="text-emerald-500 font-bold text-sm tracking-widest mb-1">
                    {features[active].num}
                  </div>
                  <h3 className="text-xl sm:text-3xl lg:text-4xl font-black text-emerald-950">
              ...
              <div className="pt-4 sm:pt-6 border-t border-slate-100 flex items-center justify-between sm:justify-start gap-3 sm:gap-6">
                ...
                <div className="text-slate-400 font-bold tracking-widest text-sm bg-slate-50 px-5 py-2.5 rounded-full">
                  <span className="text-emerald-950 text-lg">
                    {features[active].num}
                  </span>{" "}
                  / 08
                </div>
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
        {features.map((feature, idx) => (
          ...
          >
            ...
            <div>
              <div
                className={`text-[10px] font-bold tracking-widest uppercase mb-1 ${active === idx ? "text-emerald-400/80" : "text-slate-400"}`}
              >
                {feature.num}
              </div>
              <div
                className={`text-sm font-bold leading-tight ${active === idx ? "text-white" : "text-slate-700"}`}
              >
                {feature.title}
              </div>
            </div>
  ...
  const steps = [
    {
      num: "01",
      title: "تسجيل الدفعة",
      desc: "سجّل مصدر النوى والكمية والنوع والموقع والحالة، لتنشئ نواة سجلًا رقميًا للدفعة.",
      icon: Database,
    },
    {
      num: "02",
      title: "التحليل بالذكاء الاصطناعي",
      desc: "يمكن إضافة صورة للدفعة للحصول على تحليل بصري تقديري للخصائص الظاهرة. هذا التحليل لا يغني عن الفحوصات المخبرية.",
      icon: BrainCircuit,
    },
    {
      num: "03",
      title: "الاستخدامات المحتملة",
      desc: "تستعرض نواة مسارات استخدام محتملة للنوى بالاستناد إلى الأدلة والمصادر، مع الفصل بين الاستخدام المحتمل والنتيجة التي تم التحقق منها.",
      icon: Search,
    },
    {
      num: "04",
      title: "التجارب",
      desc: "تربط نواة الدفعة بالتجارب والفحوصات التي تنفذها الجامعات والباحثون والمختبرات والجهات المختصة، وتوثق نتائجها عند توفرها.",
      icon: TestTube2,
    },
    {
      num: "05",
      title: "الأدلة والنتائج",
      desc: "تربط نواة بيانات الدفعة بالأبحاث والمصادر ذات الصلة، وتوضح ما تم التحقق منه بالتجربة وما يزال ضمن نطاق الاستخدام المحتمل.",
      icon: BookOpen,
    },
    {
      num: "06",
      title: "الربط والتتبع",
      desc: "تعمل نواة كحلقة وصل رقمية بين موردي النوى والجهات المهتمة بها، مع الحفاظ على سجل الدفعة وبياناتها ومسارها.",
      icon: QrCode,
    },
    {
      num: "07",
      title: "الأثر",
      desc: "تتبع نواة المؤشرات والنتائج المرتبطة بالدفعات، مع توضيح الفرق بين البيانات الفعلية والتقديرات الحسابية.",
      icon: LineChart,
    },
  ];
    ...
    <div className="flex flex-col xl:flex-row items-center gap-16 xl:gap-32 w-full py-10 lg:py-20 overflow-visible">
      ...
      <div className="xl:w-1/2 flex justify-center items-center w-full relative h-[360px] sm:h-[520px] lg:h-[650px] xl:h-[750px] overflow-visible">
        ...
        <div className="absolute z-20 w-20 h-20 sm:w-28 sm:h-28 lg:w-40 lg:h-40 xl:w-48 xl:h-48 bg-emerald-900 rounded-full flex flex-col items-center justify-center shadow-[0_0_50px_rgba(2,44,34,0.4)] border-4 lg:border-8 border-white group">
          ...
          >
            <span className="text-white font-black text-xl sm:text-2xl lg:text-4xl xl:text-5xl tracking-tighter">
              نواة
            </span>
            <span className="text-emerald-400/80 font-bold text-[10px] sm:text-xs lg:text-base xl:text-lg tracking-widest mt-1 lg:mt-2">
              NAWAH
            </span>
          </motion.div>
        </div>
        ...
        {steps.map((step, idx) => {
          ...
          return (
            ...
            >
              <div
                className={`w-8 h-8 sm:w-14 sm:h-14 lg:w-20 lg:h-20 xl:w-24 xl:h-24 rounded-full flex items-center justify-center shadow-xl transition-all duration-300 ${
                  activeStep === idx
              ...
              >
                ...
                <div
                  className={`text-[7px] sm:text-[11px] lg:text-sm xl:text-base font-bold sm:font-black leading-tight lg:leading-snug drop-shadow-sm ${
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-6 relative z-10">
              ...
              <div>
                <div className="text-emerald-500 font-bold text-xs mb-1 uppercase tracking-widest">
            ...
            <div className="flex items-center justify-between pt-6 border-t border-slate-100 relative z-10">
              ...
              <div className="text-sm font-bold text-slate-400 font-mono tracking-widest bg-slate-50 px-4 py-1.5 rounded-full">
                {steps[activeStep].num}{" "}
                <span className="text-slate-300 mx-1">/</span> 07
              </div>
...
export default function LandingPage() {
  return (
    <div
      className="min-h-screen bg-slate-50 text-emerald-950 font-sans selection:bg-amber-200 selection:text-emerald-900 overflow-x-hidden"
      dir="rtl"
    >
      {/* 1. PRODUCT HERO */}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:max-w-7xl relative z-10 w-full">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-8 w-full">
            <div className="lg:w-1/2 space-y-8 text-center lg:text-right">
              ...
              >
                من الهدر إلى... <br />
                <span className="text-emerald-600">مورد قابل للتتبع</span>
              </motion.h1>
              ...
              >
                <span className="font-bold">نواة | NAWAH</span> منصة رقمية
                لتوثيق نوى التمر وتتبعها، وتمكين الاستفادة منها عبر تحليل
                بياناتها وربطها بالأدلة والتجارب والجهات المهتمة، ضمن مسار يدعم
                الحد من الفقد والهدر الغذائي.
              </motion.p>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="text-center space-y-4 mb-16 relative z-10">
            <h2 className="text-3xl font-black text-white">
              الفجوة التي تعالجها نواة
            </h2>
            <p className="text-emerald-100 text-lg max-w-2xl mx-auto">
              المشكلة ليست في قلة النوى، بل في أنها تُعد موردًا ثانويًا مهدرًا
              يفتقر إلى بيانات دقيقة وموثقة، مما يصعب على الباحثين والمصانع
              الوصول إليه واستغلاله.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mb-12">
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white p-6 md:p-8 rounded-[2rem] border-4 border-white shadow-[0_20px_40px_-15px_rgba(0,0,0,0.3)] flex flex-col justify-center items-center text-center group hover:-translate-y-2 hover:shadow-[0_20px_40px_-15px_rgba(16,185,129,0.4)] transition-all duration-300 relative z-10"
            >
              <div className="text-2xl sm:text-3xl md:text-4xl font-black text-emerald-950 mb-2 dir-ltr">
                1.92M
              </div>
          ...
          <div className="max-w-2xl mx-auto text-center space-y-6">
            ...
            <p className="text-lg text-emerald-50/90 leading-relaxed font-medium relative z-10">
              يرتبط قطاع التمور بكميات من النوى التي قد تُعامل كمخلفات دون توثيق
              أو تتبع واضح لمسارات الاستفادة منها. وفي المقابل، توجد أبحاث
              وتجارب واستخدامات محتملة للنوى، لكنها موزعة بين مصادر مختلفة.
              <br />
              <br />
              <span className="text-amber-300 font-bold">
                تجمع نواة هذه العناصر في رحلة رقمية واحدة قابلة للتتبع.
              </span>
            </p>
          </div>
        </div>
      ...
      <section className="py-14 sm:py-24 bg-emerald-50/60 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-5xl relative z-10">
          <div className="text-center space-y-4 mb-10 sm:mb-20">
            ...
            <p className="text-emerald-600/80 text-lg font-bold max-w-3xl mx-auto">
              تشير الدراسات إلى أن النوى قد تمثل نحو 10% من وزن الثمرة، وبناءً
              على إنتاج التمور في المملكة يمكن تقدير حجم نظري محتمل للنوى.
            </p>
          </div>
          ...
          <div className="bg-white border border-slate-100 rounded-2xl sm:rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] overflow-hidden max-w-4xl mx-auto relative">
            <div className="grid md:grid-cols-3 divide-y md:divide-y-0 md:divide-x md:divide-x-reverse divide-slate-100">
              <div className="p-6 sm:p-10 text-center flex flex-col justify-center items-center gap-4 bg-white relative group">
                ...
                <span className="text-slate-500 text-sm font-bold uppercase tracking-wider">
                  إنتاج التمور بالمملكة
                </span>
                <span className="text-2xl sm:text-3xl font-black text-emerald-950 dir-ltr">
                  1.92M
                </span>
              ...
              <div className="p-6 sm:p-10 text-center flex flex-col justify-center items-center gap-4 bg-slate-50/50 relative group">
                ...
                <span className="text-slate-500 text-sm font-bold uppercase tracking-wider">
                  نسبة النوى من الثمرة
                </span>
                <span className="text-3xl font-black text-emerald-950 dir-ltr">
                  ≈ 10%
                </span>
              ...
              <div className="p-6 sm:p-10 text-center flex flex-col justify-center items-center bg-emerald-900 text-white shadow-inner relative overflow-hidden group">
                ...
                <span className="text-emerald-100/80 text-sm font-bold mb-6 relative z-10 uppercase tracking-widest">
                  حجم النوى المحتمل
                </span>
                <span className="text-4xl sm:text-6xl font-black text-amber-400 dir-ltr relative z-10 drop-shadow-md tracking-tighter">
                  192K
                </span>
                <span className="text-emerald-50 font-bold mt-4 text-xs relative z-10 bg-white/10 backdrop-blur-sm px-4 py-1.5 rounded-full border border-white/5">
                  طن (تقدير نظري)
                </span>
              </div>
            </div>
            ...
            <div className="p-5 bg-slate-50 text-center border-t border-slate-100">
              <span className="text-xs text-slate-500 font-medium leading-relaxed max-w-2xl mx-auto block">
                هذا تقدير حسابي مبني على نسبة 10% من إنتاج التمور في المملكة
                لعام 2024، بهدف توضيح الحجم النظري المحتمل للمورد، ولا يمثل كمية
                رسمية لنوى التمر المتخلفة أو كمية تم قياسها أو جمعها فعليًا.
              </span>
            </div>
          </div>
        </div>
      ...
      <section
        id="how-it-works"
        className="py-14 sm:py-24 lg:py-32 bg-emerald-950 relative overflow-hidden"
      >
        {/* Ambient Glows */}
        ...
        <div className="container mx-auto px-4 max-w-6xl relative z-10">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-emerald-100 text-lg">
              تبدأ الرحلة بتسجيل دفعة من نوى التمر، ثم تُربط بالتحليل والأدلة
              والتجارب والأثر.
            </p>
          </div>
      ...
      <section
        id="features"
        className="py-14 sm:py-24 bg-emerald-50/50 border-t border-emerald-100/50 relative overflow-hidden"
      >
        <div className="container mx-auto px-4 max-w-6xl relative z-10">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-emerald-600/70 text-lg font-bold">
              أطراف المنظومة المستفيدة من الرحلة الرقمية
            </p>
          </div>
      ...
      <section className="py-16 sm:py-32 bg-emerald-950 text-white overflow-hidden relative">
        ...
        <div className="container mx-auto px-4 max-w-5xl relative z-10">
          <div className="text-center space-y-4 mb-10 sm:mb-20">
            ...
            <p className="text-emerald-100 text-lg">
              من التوثيق إلى الأثر
              <br />
              <span className="text-sm font-medium opacity-80 block mt-3 max-w-2xl mx-auto leading-relaxed">
                تبدأ نواة بتوثيق المورد، ثم تربط بياناته بالمعرفة والتجارب
                ومسارات الاستفادة، لتكوين سجل رقمي يمكن من خلاله متابعة النتائج
                والأثر المرتبط بكل دفعة.
              </span>
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            {[
              ...
              <div
                key={idx}
                className="flex flex-col md:flex-row items-center gap-4 w-full relative"
              >
                <motion.div
      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 max-w-3xl text-center space-y-8">
          <h2 className="text-2xl font-black text-emerald-950">
            لماذا يرتبط ذلك بالتحدي؟
          </h2>
          <p className="text-slate-600 text-lg leading-relaxed font-medium">
            يرتبط تحدي نواة بمسار الحد من الفقد والهدر الغذائي من خلال دعم
            الاستفادة من الموارد الثانوية المرتبطة بسلسلة التمور، بدل التعامل
            معها كمخلفات دون مسار واضح للتوثيق والاستفادة.
          </p>
          <div className="bg-white p-8 md:p-12 rounded-3xl border border-slate-100 shadow-sm space-y-6">
            <div className="text-3xl sm:text-5xl md:text-6xl font-black text-rose-500 dir-ltr">
              4.066M
            </div>
            <div className="text-lg font-bold text-slate-700">
              طن / الهدر الغذائي السنوي العام
            </div>
            <p className="text-xs text-slate-400 bg-slate-50 p-4 rounded-xl">
              ويعرض الرقم التالي سياق الهدر الغذائي العام في المملكة، وليس كمية
              نوى التمر تحديدًا.
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            <div className="flex-1 space-y-8 relative z-10 text-center lg:text-right">
              ...
              <h2 className="text-3xl sm:text-5xl font-black text-emerald-950 leading-tight">
                نواة في سياق <br />
                <span className="text-emerald-600">رؤية السعودية 2030</span>
              </h2>

              <p className="text-lg text-slate-600 font-medium leading-relaxed">
                تتقاطع نواة مع توجهات الرؤية في مجالات الاستدامة البيئية،
                والتحول الرقمي، واستثمار البيانات الوطنية، ودعم ممارسات الاقتصاد
                الدائري وتعظيم الاستفادة من الموارد المحلية، متماشية مع
      ...
      <section
        id="why-nawah"
        className="py-24 sm:py-32 bg-emerald-50 text-center relative overflow-hidden"
      >
        ...
        <div className="container mx-auto px-4 max-w-5xl space-y-20 relative z-10">
          <div className="space-y-6">
            ...
            >
              القيمة ليست في تسجيل النوى فقط، بل في ربط الدفعة بمصدرها وبياناتها
              وتحليلها وأدلتها وتجاربها ونتائجها في سجل رقمي واحد.
              <br />
              <span className="text-emerald-600 font-bold">
                بهذا تنتقل نواة من مجرد تسجيل المورد إلى بناء مسار رقمي يساعد
                على فهمه وتتبع الاستفادة منه.
              </span>
            </motion.p>
          </div>
          ...
          >
            ...
            <p className="text-2xl sm:text-3xl font-black text-white mb-16 relative z-10">
              لكن القيمة الأكبر تظهر عندما تصبح هذه العناصر{" "}
              <span className="text-amber-400">مرتبطة ببعضها رقميًا</span>.
            </p>
            ...
            <div className="relative flex flex-wrap lg:flex-nowrap items-center justify-center gap-4 sm:gap-6 text-sm sm:text-base font-bold text-emerald-950 z-10 mb-12">
              ...
              {[
                ...
                { id: "تتبع", color: "bg-emerald-500" },
                {
                  id: "أثر",
                  color:
                    "bg-amber-400 text-emerald-950 shadow-[0_0_20px_rgba(251,191,36,0.4)]",
                },
              ].map((step, idx) => (
                <motion.div
                  key={idx}
            ...
            <p className="text-sm text-emerald-100/60 font-medium max-w-xl mx-auto mb-6 relative z-10">
              تعتمد نواة على سجلات رقمية مترابطة لتتبع الدفعات وربطها بالتحليل
              والتجارب والأدلة وقياس الأثر لضمان الشفافية والموثوقية.
            </p>

            <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 gap-8 text-right mt-12 pt-10 border-t border-white/10">
              <div>
                <h3 className="text-lg font-black text-amber-400 mb-3">
                  رؤيتنا
                </h3>
                <p className="text-emerald-50 text-sm leading-relaxed font-medium">
                  أن تصبح نوى التمر موردًا ثانويًا قابلًا للتتبع والدراسة
                  والاستفادة، من خلال منظومة رقمية تربط البيانات بالأدلة
                  والتجارب والجهات المهتمة.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-black text-amber-400 mb-3">
                ...
                <p className="text-emerald-50 text-sm leading-relaxed font-medium">
                  تمكين الاستفادة من نوى التمر عبر توثيق بياناتها، وربطها
                  بالتحليل والأدلة والتجارب والنتائج، وبناء حلقة وصل رقمية بين
                  المورد والجهات المهتمة به.
                </p>
              </div>
            </div>
          </motion.div>
