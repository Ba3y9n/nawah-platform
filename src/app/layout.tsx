...
{/* 9. DEVELOPMENT TEAM */}
      <section className="pb-16 pt-6 bg-emerald-950">
        <div className="container mx-auto px-4 max-w-5xl text-center space-y-8 relative">
          ...
          <h2 className="text-xs font-bold text-emerald-400/80 tracking-widest uppercase relative z-10">���� �������</h2>
          
          <div className="flex flex-wrap items-center justify-center gap-3 relative z-10">
            {[
              { name: "���� �������", link: "https://www.linkedin.com/in/bayan-almutairi-93a872333?utm_source=share_via&utm_content=profile&utm_medium=member_ios" },
              { name: "��� �������", link: "https://www.linkedin.com/in/ayah-alsadany" },
              { name: "��� ���������", link: "https://www.linkedin.com/in/hibah-alharbi-ab0b2938a?utm_source=share_via&utm_content=profile&utm_medium=member_ios" },
              { name: "���� ������", link: "https://www.linkedin.com/in/haneen-al-qassir-b68aa4387?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" },
              { name: "���� ������", link: "https://www.linkedin.com/in/wafaa-undefined-975a7829a?utm_source=share_via&utm_content=profile&utm_medium=member_ios" },
              { name: "�. ���� ������", link: null }
            ].map((m, i) => (
              m.link ? (
